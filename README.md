...
R package **edgeTransport**, version **3.5.1**
...
Hoppe J, Dirnaichner A, Rottoli M, Muessel J, Hagen A, Pietzcker R (2026). "edgeTransport: Prepare EDGE Transport Data for the REMIND model." Version: 3.5.1, <https://github.com/pik-piam/edgeTransport>.
